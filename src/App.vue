<template>
          	...
          	<div class="container relative">
            	...
            	<div class="pull-left">
              		...
              		<div class="header-inner">
	                	<!-- BEGIN LOGO -->
	                	<a href="/">
	                  		<img src="/images/logos/text.png" width="152" height="21" data-src-retina="/images/logos/retina.png" class="logo" alt="SeaOrganizer">
	                  		<img src="/images/logos/text_white.png" width="152" height="21" data-src-retina="/images/logos/retina_white.png" class="alt" alt="">
	                	</a>
              		</div>
            	</div>
    ...
    <div class="page-wrappers" id="so-frontend">
      	<router-view/>
    </div>
